...
static const char *fonts[]          = { "curie:size=12" }; /* FURA CODE */
...
static const char *sflockcmd[] = { "/usr/bin/sflock", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_l,	   spawn,	   {.v = sflockcmd } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
